 ...
 * CResource - Отзывы
 *
 * Вывод отзывов из кастомной таблицы
 *
...
// ********************************** //
// вывод в админку дочерних ресурсов (в данном случае - вывод дочерних ресурсов "вопрос-ответ" из кастомной таблицы modx_customtable_19 
// для родителя "вопросы-ответы", имеющего шаблон с id=19 по конфигу customtable_19.data.json
// 
// все конфиги находятся в папке assets\plugins\CResource\config
// 
// !! прочитайте еще раз внимательно предыдущие 3 строки, чтобы уловить, что везде есть число 19 в конце :) - это связующее звено
// ********************************** //
